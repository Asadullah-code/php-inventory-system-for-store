...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        echo '<tr><th style="padding: 6px 10px;">Operator Number</th><th style="padding: 6px 10px;">Product Name</th><th style="padding: 6px 10px;">Operator Date</th><th style="padding: 6px 10px;">Quantity</th></tr>';
        ...
        echo 'No Operators found for the specified date range.';
    }
} else {
